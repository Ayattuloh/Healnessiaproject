			...
			<div class="row">
				<div class="col-md-12">
					<div class="block text-center">
						...
						<h1 class="text-capitalize mb-5 text-lg">Bookmark</h1>
	...
	<section class="section service-2">
		<div class="container">
            ...
            <?php
                ...
                $sql = 'SELECT tbl_informasi.* from tbl_informasi JOIN tbl_bookmark ON tbl_bookmark.idUser='.$idUser.' AND tbl_bookmark.idInformasi=tbl_informasi.id_informasi';

			...
			<div class="row">
				<div class="col-lg-6 col-md-12 col-xl-7">
					<div class="block">
						...
						<span class="text-uppercase text-sm letter-spacing ">Bangkitnya Kesadaran Masyarakat Indonesia</span>
						<h1 class="mb-3 mt-3">Sahabat Informasi Seputar Kesehatan Anda</h1>

						<p class="mb-4 pr-5">HEALNESSIA adalah website yang berisi informasi kesehatan dunia, website ini memiliki berbagai penjelasan dan fitur yang mendukung dan mudah dipahami oleh masyarakat.</p>
				...
				<div class="col-lg-12">
					<div class="feature-block d-lg-flex">
						<div class="feature-item mb-5 mb-lg-0">
							...
							<span>Informasi 24 Jam</span>
							<h4 class="mb-3">Online Appoinment</h4>
							<p class="mb-4">Dapatkan Informasi Up To Date Tentang Penyakit yang Ingin Anda Ketahui Selama 24 Jam.</p>
						...
						<div class="feature-item mb-5 mb-lg-0">
							...
							<span>Waktu Maintenance</span>
							<h4 class="mb-3">Hari Maintenance</h4>
							<ul class="w-hours list-unstyled">
								<li class="d-flex justify-content-between">Senin - Minggu : <span>Menyesuaikan</span></li>
							</ul>
						</div>
						...
						<div class="feature-item mb-5 mb-lg-0">
							...
							<h4 class="mb-3">Healnessia@gmail.com</h4>
							<p>Kirimkan semua keluhan anda pada email diatas.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-4 col-sm-6">
					<div class="about-img">
						<img src="images/about/vaksin_v4.jpg" alt="" class="img-fluid">
						<img src="images/about/HIV.jpg" alt="" class="img-fluid mt-4">
					</div>
				</div>
				<div class="col-lg-4 col-sm-6">
					<div class="about-img mt-4 mt-lg-0">
						<img src="images/about/monkeypox.jpg" alt="" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-4">
					<div class="about-content pl-4 mt-4 mt-lg-0">
						<h2 class="title-color">Lokasi <br>& Penjelasan Vaksin</h2>
						<p class="mt-4 mb-5">Dapatkan Informasi mengenai vaksinasi yang anda ingin Ketahui.</p>

						<a href="vaksin.php" class="btn btn-main-2 btn-round-full btn-icon">Vaksinasi<i class="icofont-simple-right ml-3"></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<div class="section-title">
						<h2>TOP 3 PENYAKIT MEMATIKAN</h2>
						<div class="divider mx-auto my-4"></div>
						<p>Dibawah merupakan 3 besar dari penyakit yang sangat berbahaya bagi tubuh manusia.</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="service-item mb-4">
						<div class="icon d-flex align-items-center">
							<i class="icofont-aids text-lg"></i>
							<h4 class="mt-3 mb-3">AIDS</h4>
						</div>

						<div class="content">
							<p class="mb-4">AIDS adalah tahapan akhir dari penyakit infeksi human immunodeficiency virus (HIV).</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="service-item mb-4">
						<div class="icon d-flex align-items-center">
							...
							<h4 class="mt-3 mb-3">Stroke</h4>
						</div>
						<div class="content">
							<p class="mb-4">Stroke menjadi penyakit tidak menular yang menyebabkan kasus kematian terbanyak.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="service-item mb-4">
						<div class="icon d-flex align-items-center">
							...
							<h4 class="mt-3 mb-3">Gagal ginjal kronis</h4>
						</div>
						<div class="content">
							<p class="mb-4">Gagal ginjal kronis adalah kondisi ketika fungsi ginjal menurun secara bertahap akibat kerusakan jaringan ginjal.</p>
						</div>
					</div>
				</div>
...
<section class="section clients">
	...
	<!-- footer Start -->
	<footer class="footer section white-bg">
		<div class="container">
			<div class="row">

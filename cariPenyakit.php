...
<body id="top">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block text-center">
						...
						<h1 class="text-capitalize mb-5 text-lg">Pusat Informasi Penyakit</h1>
	...
	<section class="section service-2">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<div class="section-title">
						<h2>Kenali Penyakit Anda!</h2>
						<div class="divider mx-auto my-4"></div>
						<p>Dengan mengenali penyakit yang sedang anda alami, penyembuhan dan pemulihan dapat dilakukan dengan tepat
						<p>
					</div>
				</div>
			</div>
            <div class="row">
            <?php
                $pencarian = $_GET['searching'];

                $sql = 'SELECT * FROM tbl_informasi WHERE namaPenyakit LIKE "%'.$pencarian.'%" OR deskPenyakit LIKE "%'.$pencarian.'%"';
                ...
                while ($row = mysqli_fetch_object($query)) {
                    ...
                    <img src="'.$row->pathGambar.'" alt="" class="img-fluid w-100">
                    <div class="content">
                    <h4 class="mt-4 mb-2 title-color">'.$row->namaPenyakit.'</h4>
                     <p class="mb-4">'.$row->infoPenyakit.'</p>
                     <form action="penyakit.php" method="POST">
                     <input type="hidden" name="penyakit" value="'.$row->id_informasi.'" />
                     <button type=submit class="btn btn-light">Learn More <i class="icofont-simple-right ml-2"></i></button>
                     </form>
                    </div>
                    </div>
                    </div>';
